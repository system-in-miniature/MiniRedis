# Stage 14 · Canonical persistence frames
...
#### Canonical payloads and checksummed frames

Encode stable values as strict canonical JSON and wrap AOF/snapshot payloads with versioned headers, lengths, and CRC32.
...
#### Bounded AOF tail repair

Treat only one incomplete final frame as repairable; reject checksum, schema, header, and sequence corruption without rewriting evidence.
...
[Compare this stage on GitHub](https://github.com/system-in-miniature/mini-redis/compare/5a40b5f...633bbe6)

After finishing, run `python -m journey.tools.build_journey check 14` to verify the learner workspace.
